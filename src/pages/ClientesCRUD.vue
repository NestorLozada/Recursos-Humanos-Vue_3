                ...
                <tbody>
                  <tr v-for="(costo, index) in costos" :key="index">
                    ...
                    <td>
                      ...
                      <div v-if="isModalVisibleNuevo" class="modal1">
                        <div class="modal-content1">
                          ...
                          <input
                              ...
                              id="NombreCentroCostos"
                            />
                            <h2>Ingresa Descripción</h2>
                          <input
                              type="number"
                              id="descripcioncentrocostos"
                            />
                            
                            <div class="btnMdiv">
                              <button class="btnModel" @click="editarCosto(2, index)">Guardar</button>
                              <button class="btnModel" @click="closeModal()">Cancelar</button>
                            </div>
                        </div>
                      </div>
  ...
  export default {
    ...
    methods: {
      ...
      closeModal() {
        ...
        this.isModalVisibleNuevo= false;
      },
